...
const USERS = [
  { id: 1, name: "Sarah Johnson", email: "sarah@example.com", role: "Designer", status: "active" as const, initials: "SJ" },
  { id: 2, name: "Mike Chen", email: "mike@example.com", role: "Engineer", status: "active" as const, initials: "MC" },
  { id: 3, name: "Alex Rivera", email: "alex@example.com", role: "Product", status: "pending" as const, initials: "AR" },
  { id: 4, name: "Emma Wilson", email: "emma@example.com", role: "Marketing", status: "inactive" as const, initials: "EW" },
  { id: 5, name: "James Park", email: "james@example.com", role: "Engineer", status: "active" as const, initials: "JP" },
];

type UserStatus = "active" | "pending" | "inactive";

const statusConfig: Record<UserStatus, { label: string; class?: string; variant?: "outline" | "secondary" }> = {
...
export const UsersTable: Story = {
  ...
  render: () => {
    const [sort, setSort] = useState<{ field: keyof typeof USERS[0]; dir: "asc" | "desc" }>({ field: "name", dir: "asc" });
    ...
    const toggleSort = (field: keyof typeof USERS[0]) =>
      setSort((s) =>
        s.field === field
...
export const InvoiceTable: Story = {
  ...
  render: () => {
    const invoices = [
      { id: "INV-001", date: "Jan 5, 2026", amount: "$250.00", status: "paid" as const },
      { id: "INV-002", date: "Jan 20, 2026", amount: "$180.00", status: "paid" as const },
      { id: "INV-003", date: "Feb 3, 2026", amount: "$320.00", status: "pending" as const },
      { id: "INV-004", date: "Feb 15, 2026", amount: "$95.00", status: "overdue" as const },
    ];
